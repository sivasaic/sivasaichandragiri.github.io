...
- [The Hypothesis: Endothelial Senescence Drives Vascular Fragility](#hypothesis)
...
- **Subjects**: Young mice
- **Treatment**: Fractionated WBI protocol (5 Gy twice weekly for four weeks total of 40 Gy)
- **Timepoint**: Two months post-treatment
...
###| fig-cap: "Cell type abundance across control and WBI-treated samples"
...
###| fig-cap: "Senescence score distribution across endothelial subtypes"
```
### Key Observation
...
# Apply senescence threshold (based on your calculation)
...
All code available at: [your GitHub link]