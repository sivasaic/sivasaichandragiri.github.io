...
- **Subjects:** Young mice [n=4 both groups]  
...
###| fig 1: Cell type abundance across control and WBI-treated samples. [Y= Young Control, YWBI= Young WBI; n=4 both groups]
```
### Key Observation
...
#threshold = 0.8 * 0.168
threshold = quantile(plot.data$score, 0.8)
